...
const Navbar=()=>{
  return(
    <>
    <div className="container-fluid- nav_bg" id="startnav">
        <div className='row'>
  ...
  <div className="container-fluid">
    <NavLink className="navbar-brand" to="#">Unnati Singh</NavLink>
    <div class="d-lg-none"><button classNameName="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <NavLink activeClassName="menu_active" exact className="nav-link" to="/Contact">Contact Me</NavLink>
        </li>
